...
producción de exámenes multilingües con múltiples modelos en cada
idioma. Pueden utilizarse sólo partes, como las definiciones en
...
% % \selectlanguage{spanish}
% % \begin{figure}
% % \caption{Proceso de generación de documentos con \texttt{EA3examen}}
