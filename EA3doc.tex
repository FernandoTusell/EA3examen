...
En derogación parcial de la norma anterior, tanto en español como en
inglés prevalece el convenio de emplear abreviaturas de unidades con
...
En español e inglés, al menos, las abreviaturas de unidades se emplean
...
de unidades físicas. Si se trata de unidades monetarias, el paquete
\href{https://ctan.org/pkg/currency}{currency} ayuda a mantener un
formato consistente.
...
autores, licenciados en diferentes términos. Es nuestra creencia que
el uso que hacemos del mismo no infringe ningún copyright.

Lo que hemos escrito nosotros
(\texttt{moodleiza}, \texttt{exam2moodle.pl}, macros para \LaTeX2e y
para Emacs) es de fuente
libre bajo licencia GPL, y puede obtenerse del repositorio GitHub
